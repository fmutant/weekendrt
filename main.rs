...
fn degrees_to_radians(degrees: f32) -> f32 { return degrees * PI / 180.0f32; }
...
fn main() {	
	...
	let lower_left_corner: Vec3 = origin - horizontal * 0.5f32 - vertical * 0.5f32 - Vec3::new(0.0f32, 0.0f32, focal_length);
	let direction_origin: Vec3 = lower_left_corner - origin;
	...
	for j in (0u32..image_height).rev() {
		...
		for i in 0..image_width {
			let u = (i as f32) * image_width_inv;
			let v = (j as f32) * image_height_inv;
